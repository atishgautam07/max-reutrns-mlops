...
from simulate_strategy import StrategySimulation
...
#         model_prediction = PredictionPipeline(config=model_prediction_config)
#         model_prediction.load()
...
#         model_monitoring.load()
#         model_monitoring.predict()
#         model_monitoring.write_metrics()


class SimulateStrategyPipeline:
    def __init__(self):
        pass

    def main(self):
        config = ConfigurationManager(bucket_name, gcs_file_path)
        simulate_strategy_config = config.get_simulate_strategy_config()
        simulate_strategy = StrategySimulation(config=simulate_strategy_config)
...
# try:
#     print(f">>>>>> stage {STAGE_NAME} started <<<<<<")
#     model_monitor = ModelMonitoringTrainingPipeline()
#     model_monitor.main()
#     print(f">>>>>> stage {STAGE_NAME} completed <<<<<<\n\nx==========x")
# except Exception as e:
#     print(e)
...
# try:
#     print(f">>>>>> stage {STAGE_NAME} started <<<<<<")
#     model_pred = ModelPredictionTrainingPipeline()
#     model_pred.main()
#     print(f">>>>>> stage {STAGE_NAME} completed <<<<<<\n\nx==========x")
# except Exception as e:
#     print(e)
...
STAGE_NAME = "Simulate Strategy stage"
try:
    print(f">>>>>> stage {STAGE_NAME} started <<<<<<")
    model_monitor = SimulateStrategyPipeline()
    model_monitor.main()
    print(f">>>>>> stage {STAGE_NAME} completed <<<<<<\n\nx==========x")
except Exception as e:
    print(e)
